...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	vertexResourceDesc.Width = sizeof(Vector4) * 3;//リソースのサイズ。こんかいはVector4を３頂点分
	//バッファの場合はこれらは１にする決まり
	...
	hr = device->CreateCommittedResource(&uplodHeapProperties, D3D12_HEAP_FLAG_NONE, &vertexResourceDesc, D3D12_RESOURCE_STATE_GENERIC_READ, nullptr, IID_PPV_ARGS(&vertexResource));
	assert(SUCCEEDED(hr));
	//頂点バッファビューを作成する
